...
# Usage: ./lane1/scripts/setup_db.sh
# Reads the same S03_DB_* env vars as lane1/db.py (falls back to local defaults).
...
echo "Done. Try: python3 lane1/scripts/self_test.py"